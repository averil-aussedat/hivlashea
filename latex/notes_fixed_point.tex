...
\myproof{
	Since $\K \subset \mathcal{C}^{0}([0,1],\mathbb{R})$, we know that any Cauchy sequence $(\varphi^n)_n \subset \K$ admits a limit $\varphi \in \mathcal{C}([0,1],\mathbb{R})$. The pointwise conditions
	\begin{align*}
		\varphi^n(0)=0, \quad \varphi^n(1) \geqslant -\beta, \quad \varphi^n((1-\gamma) x + \gamma y) \geqslant (1-\gamma) \varphi^n(x) + \gamma \varphi^n(y) + \frac{\alpha}{2} \gamma(1-\gamma) |x-y|^2 \quad \forall (x,y,\gamma) \in [0,1]^3
	\end{align*}
	are preserved when $n\to\infty$ under this topology. Let us show that $\varphi'(0)=0$: first, notice that $\varphi^n(x) \leqslant 0$ implies $\varphi(x) \leqslant 0$. Since $\varphi$ is $\alpha-$concave, we have $\forall x \in [0,1]$
	\begin{align*}
		\varphi(x) \geqslant (1-x) \varphi(0) + x \varphi(1) + \frac{\alpha}{2} x (1-x) \geqslant - \beta x + \frac{\alpha}{2} x (1-x),
	\end{align*}
	and
	\begin{align*}
		\frac{- \beta \varepsilon + \frac{\alpha}{2} \varepsilon (1-\varepsilon)}{\varepsilon} \leqslant \frac{\varphi(\varepsilon) - \varphi(0)}{\varepsilon} \leqslant 0. 
	\end{align*}
}
