...
thefile = "../../DynamicElectricSheath.jl/data/one_species/errs.txt"
cols = [0, 1, 2, 4, 5]
# syntax : [filepath, rows, cols, sep, comment]
sources = [[thefile,[":"],cols,sep,comment]]
...
caption     = "DF errors for Malkov test case." # Optional (ignore the warning if commented)
label       = "tab:Malkov_DF"      # Optional (ignore the warning if commented)
vertical_lines_inside_blocks = False # !! weird in recursive headings
double_hlines = [3] # numbering starts at 0
