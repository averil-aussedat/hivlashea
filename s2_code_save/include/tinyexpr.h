 ...
 *
 * THIS IS AN ALTERED SOURCE VERSION: MERGED .h AND .c, AND ADDED LOGICAL_IF
...
For a^b^c = (a^b)^c and -a^b = (-a)^b the following line has to be commented.
For a^b^c = a^(b^c) and -a^b = -(a^b) the following line has to be uncommented. */
#define TE_POW_FROM_RIGHT

/* Logarithms
For log = base 10 log the following line has to be commented.
For log = natural log the following line has to be uncommented. */
/* #define TE_NAT_LOG */
...
static double logical_true(void) {return 1.;}
static double logical_false(void) {return 0.;}
...
static double logical_if(double test, double f_then, double f_else) {
    return test ? f_then : f_else;
}
...
static const te_variable functions[] = {
    ...
    {"erf", erf,             TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"exp", exp,             TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"fac", fac,             TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"false", logical_false, TE_FUNCTION0 | TE_FLAG_PURE, 0},
    {"floor", floor,         TE_FUNCTION1 | TE_FLAG_PURE, 0},
    {"if", logical_if,       TE_FUNCTION3 | TE_FLAG_PURE, 0},
    ...
    {"true", logical_true,   TE_FUNCTION0 | TE_FLAG_PURE, 0},
    {0, 0, 0, 0}
};
