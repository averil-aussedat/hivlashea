...
compile_gcc() {
  ...
  mpicc -I$HIVLASHEA_HOME/include -I$INCLUDE_HDF5 -L$LIBRARY_HDF5 -I$INCLUDE_FFTW -L$LIBRARY_FFTW vp_1d1v_cart_2sp_cemracs2022_two_vmeshes.c -lsz -lz -lm -lhdf5 -O3 -march=native -std=gnu11 -Wall -Wfloat-conversion -o build/hivlashea.out
}
